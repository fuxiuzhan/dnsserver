package com.fxz.DNSServer.Mail;
...
public class SendMail {
	...
	public void sendMail(String from, String to, String title, String context) throws AddressException, MessagingException, UnsupportedEncodingException {
		...
		setDate(new Date());
		setFrom(from);
		setContent(context, "text/html; charset=UTF-8");
		sendMessage();
	}
}